...
game:GetService("ScriptInformationProvider"):SetAssetUrl("http://www.retblox.tk/Asset/")
...
if not inStudio and not addedBuildTools then
  ...
  pcall(function() game:GetService("ScriptContext"):AddCoreScript(4244243,screenGui,"BuildToolsScript") end)
